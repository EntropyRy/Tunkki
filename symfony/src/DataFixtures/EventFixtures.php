...
final class EventFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $unpublished->setEventDate((new \DateTimeImmutable('+2 days'))->setTime(20, 0));
        $unpublished->setPublished(false);
        $unpublished->setUrl('unpublished-event');
        $unpublished->setTemplate('event.html.twig');
        $unpublished->setContent('<p>EN: This event is intentionally unpublished.</p>');
        $unpublished->setSisallys('<p>FI: Tämä tapahtuma on tarkoituksella julkaisematon.</p>');
        ...
        $external->setEventDate((new \DateTimeImmutable('+3 days'))->setTime(18, 0));
        ...
        $external->setSisallys('<p>FI: Tämä tapahtuma uudelleenohjaa ulkoiseen osoitteeseen.</p>');
        ...
        $tickets->setEventDate((new \DateTimeImmutable('+5 days'))->setTime(21, 0));
        ...
        $tickets->setSisallys('<p>FI: Tähän tapahtumaan on saatavilla lippuja.</p>');
