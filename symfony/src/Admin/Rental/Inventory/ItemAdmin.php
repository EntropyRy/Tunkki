...
/**
 * @extends AbstractRentalAdmin<Item>
 */
class ItemAdmin extends AbstractRentalAdmin
{
    #[\Override]
        ...
        if ($this->isGranted('EDIT')) {
            ...
            $menu->addChild('Status', [
                'uri' => $admin->generateUrl(
                    'entropy.admin.statusevent.create',
                    ['id' => $id],
                ),
            ]);
            $menu->addChild('Files', [
                'uri' => $admin->generateUrl('entropy.admin.file.list', [
                    'id' => $id,
                ]),
            ]);
        }
