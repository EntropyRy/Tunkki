 ...
 *     page?: array{
 *         default?: scalar|null|Param, // Default: "sonata.seo.page.default"
 *         head?: array<string, scalar|null|Param>,
 *         metas?: array<string, array<string, scalar|null|Param>>,
 *         separator?: scalar|null|Param, // Default: " - "
 *         title?: scalar|null|Param, // Default: ""
 *         title_prefix?: scalar|null|Param, // Default: null
 *         title_suffix?: scalar|null|Param, // Default: null
 *     },
 *     sitemap?: array{
 ...
 *     skip_redirection?: scalar|null|Param, // To skip asking Editor to redirect // Default: false
 *     hide_disabled_blocks?: scalar|null|Param, // Default: false
 *     use_streamed_response?: scalar|null|Param, // Set the value to false in debug mode or if the reverse proxy does not handle streamed response // Default: false
 *     multisite: scalar|null|Param, // For more information, see https://docs.sonata-project.org/projects/SonataPageBundle/en/4.x/reference/multisite/
 ...
 *         enabled?: bool|Param, // Default: false
 *         priority?: int|Param, // Default: 150
 *     },
 *     ignore_route_patterns?: list<scalar|null|Param>,
 *     ignore_routes?: list<scalar|null|Param>,
 *     ignore_uri_patterns?: list<scalar|null|Param>,
 *     default_page_service?: scalar|null|Param, // Default: "sonata.page.service.default"
 *     default_template: scalar|null|Param, // Template key from templates section, used as default for pages
 *     templates: array<string, array{ // Default: []
 *         name?: scalar|null|Param,
 *         path?: scalar|null|Param,
 *         inherits_containers?: scalar|null|Param,
 *         containers?: array<string, array{ // Default: []
 *             name?: scalar|null|Param,
 *             shared?: bool|Param, // Default: false
 *             type?: scalar|null|Param, // Default: 1
 *             blocks?: list<scalar|null|Param>,
 *         }>,
 *         matrix?: array{
 *             layout: scalar|null|Param,
 *             mapping: list<scalar|null|Param>,
 *         },
 *     }>,
 *     templates_admin?: array{
 *         list?: scalar|null|Param, // Default: "@SonataPage/PageAdmin/list.html.twig"
 *         tree?: scalar|null|Param, // Default: "@SonataPage/PageAdmin/tree.html.twig"
 *         compose?: scalar|null|Param, // Default: "@SonataPage/PageAdmin/compose.html.twig"
 *         compose_container_show?: scalar|null|Param, // Default: "@SonataPage/PageAdmin/compose_container_show.html.twig"
 *         select_site?: scalar|null|Param, // Default: "@SonataPage/PageAdmin/select_site.html.twig"
 *     },
 *     page_defaults?: array<string, array{ // Default: []
 *         decorate?: bool|Param, // Default: true
 *         enabled?: bool|Param, // Default: true
 *     }>,
 *     catch_exceptions?: array<string, mixed>,
 *     class?: array{
 *         page?: scalar|null|Param, // Default: "App\\Entity\\SonataPagePage"
 *         snapshot?: scalar|null|Param, // Default: "App\\Entity\\SonataPageSnapshot"
 *         block?: scalar|null|Param, // Default: "App\\Entity\\SonataPageBlock"
 *         site?: scalar|null|Param, // Default: "App\\Entity\\SonataPageSite"
 *     },
 *     direct_publication?: bool|Param, // Generates a snapshot when a page is saved from the admin. You can use %kernel.debug%, if you want to publish in dev mode, but not in prod. // Default: false
 * }
 ...
 *     entity_manager?: scalar|null|Param, // Default: "default"
 *     audited_entities?: list<scalar|null|Param>,
 *     global_ignore_columns?: list<scalar|null|Param>,
 *     table_prefix?: scalar|null|Param, // Default: ""
 *     table_suffix?: scalar|null|Param, // Default: "_audit"
 *     revision_field_name?: scalar|null|Param, // Default: "rev"
 *     revision_type_field_name?: scalar|null|Param, // Default: "revtype"
 *     revision_table_name?: scalar|null|Param, // Default: "revisions"
 *     disable_foreign_keys?: scalar|null|Param, // Default: false
 *     revision_id_field_type?: scalar|null|Param, // Default: "integer"
 *     service?: array{
 *         username_callable?: scalar|null|Param, // Default: "simplethings_entityaudit.username_callable.token_storage"
 *     },
 * }
